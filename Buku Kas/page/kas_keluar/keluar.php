                                ...
                                <table class="table table-dark" id="dataTables-example" style="background:#B7E5DD">
                                   ...
                                   ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td id="jumlah_satuan" style="text-align: center;"><?php echo number_format( $data['keluar']).",-"; ?></td>
                                            <td style="text-align: center;"><a id="edit_data" data-toggle="modal" data-target="#edit"data-id="<?php echo$data['kode'] ?> "data-ket="<?php echo$data['keterangan'] ?>"data-tgl="<?php echo $data['tanggal']  ?>"data-jml="<?php echo $data['keluar'] ?>" class="btn btn-info" /><i class="fa fa-edit"></i> Edit</a>  <a onclick="return confrim('Yakin hapus data ini?')"href="?page=keluar&aksi=hapus&id=<?php echo$data['kode'];  ?>" class="btn btn-danger"><i class="fa fa-trash"></i>Hapus</a>
                                            </td>
                                  ...
                                  <td style="background-color: gray;" ><b>Jumlah kas keluar</b></td>
                                  <td style="background-color: gray;"></td>
                                  <td style="background-color: gray;"></td>
                                  <td style="background-color: gray;"></td>
                                  <td style="background-color: gray;"></td>
                                  <td style="text-align: right; background-color: gray;"><b><?php echo"Rp.".number_format( $total).",-";?></b></td>
                                </table>
                            </div>
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                            <label>Jumlah</label>
                                            <input class="form-control" name="keluar" placeholder="Masukan jumlah transaksi di nota" />
                                        </div>
                                        </div>
                                    ...
                                    $kode=$_POST['kode'];
                                     $ket=$_POST['ket'];
                                      $tgl=$_POST['tgl'];
                                       ...
                                       $sql=$koneksi->query("insert into kas(kode,keterangan,tanggal,jumlah,jenis,keluar)values('$kode','$ket','$tgl','0','keluar','$jumlah')");
                                     }
                                       if($sql)
                                       {
                                        ?>
                                     ...
                                     $ket=$_POST['ket'];
                                      $tgl=$_POST['tgl'];
                                       $jumlah=$_POST['keluar'];
                                         ...
                                         $sql=$koneksi->query("update kas set keterangan='$ket',tanggal='$tgl',jumlah='$keluar'where kode='$kode'");
                                       if($sql)
                                       {
                                        ?>
                                        <script type="text/javascript">
